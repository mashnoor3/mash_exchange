...
SECRET_KEY = 'p5p+ax0n5^ce0&)o%4ve^@5!-t!a89)4ax()oqx@e^32e(8ji3'
...
ACCOUNT_EMAIL_REQUIRED = False #Set to True to require email address for signup
ACCOUNT_EMAIL_VERIFICATION = None #Set to 'mandatory' when want verified email address
